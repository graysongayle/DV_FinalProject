...
This graph shows a trend of countries that are classified by the United Nations as "Least Developed" in which more children are finishing their primary more and more as the years go on. However, it appears that starting in 2011, the rate of children finishing their primary education seemes to be plateauing in the high 60% range. Before this shift, there are constant linear growth in this area. 
...
This cross-tab shows spending on various levels of education by several different countries. Niger, for example, has a relativley low spending percentage on primary education at 10%, but then spends a relativley huge amount on secondary education at 25%. Another interesting case is Guyana, which spends low amounts on primary and secondary education, but spends huge amounts on their tertiary education. 
...
This trendline shows the percent of kids who complete primary school amongst the least developed countries according to the UN. It can be seen here that there is an upward positive trend as the years progress. More students are completing primary school. This may also shed some light on these countries and their corresponding wealth.
...
This plot shows the average percentage of GDP per capita that is spent per student. These percentages are plotted as individual data points across the the years 2006 to 2012. It is intersting to see that government spending has only increased in tertiary education and remained constant in primary and secondary institutions. Higher education could be becoming more valued as time increases.
